...
import * as sc from '../2015/ExDConfig/scxml';
...
interface _SCXMLStateMachine extends _StateMachine {
	src: string;
	scxml?: sc.scxmlscxmltype;
}
export interface SCXMLStateMachine extends _SCXMLStateMachine { constructor: { new(): SCXMLStateMachine }; }
export var SCXMLStateMachine: { new(): SCXMLStateMachine };
